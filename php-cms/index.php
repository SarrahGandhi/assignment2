...
<body class="bg-light">
  ...
  <div class="container my-5">
    <h1 class="text-center mb-4">Welcome to My Recipe Website!</h1>
    <p class="text-center text-muted">Discover delicious recipes and explore new flavors!</p>
      ...
      echo '<div class="col-12 col-md-4 mb-4">  <!-- col-md-4 to show 3 items in a row on medium screens and up -->
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="admin/details.php" method="get">
